...
////  use for CLIP_UAT_RESULTS_DATA ////
     test_id = '99355838-a5c8-4b16-9b66-576ed6c3d0cc'  //select your test ID 
...
WHEN PRE_CLIP_LINE_LIMIT > 0 AND PRE_CLIP_LINE_LIMIT <= 1000 AND RISKGROUP_DSERIES_Y1 = 1 AND average_utilization_3_months_FLOAT > 0 AND average_utilization_3_months_FLOAT < 0.1 AND ab_testing_random_number_FLOAT >= 0.2 AND ab_testing_random_number_FLOAT < 1 THEN 2000
WHEN PRE_CLIP_LINE_LIMIT > 0 AND PRE_CLIP_LINE_LIMIT <= 1000 AND RISKGROUP_DSERIES_Y1 = 1 AND average_utilization_3_months_FLOAT >= 0.1 AND average_utilization_3_months_FLOAT < 0.3 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
WHEN PRE_CLIP_LINE_LIMIT > 0 AND PRE_CLIP_LINE_LIMIT <= 1000 AND RISKGROUP_DSERIES_Y1 = 1 AND average_utilization_3_months_FLOAT >= 0.3 AND average_utilization_3_months_FLOAT < 0.5 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
WHEN PRE_CLIP_LINE_LIMIT > 0 AND PRE_CLIP_LINE_LIMIT <= 1000 AND RISKGROUP_DSERIES_Y1 = 1 AND average_utilization_3_months_FLOAT >= 0.5 AND average_utilization_3_months_FLOAT < 0.8 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
WHEN PRE_CLIP_LINE_LIMIT > 0 AND PRE_CLIP_LINE_LIMIT <= 1000 AND RISKGROUP_DSERIES_Y1 = 1 AND average_utilization_3_months_FLOAT >= 0.8 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
WHEN PRE_CLIP_LINE_LIMIT > 0 AND PRE_CLIP_LINE_LIMIT <= 1000 AND RISKGROUP_DSERIES_Y1 = 2 AND average_utilization_3_months_FLOAT > 0 AND average_utilization_3_months_FLOAT < 0.1 AND ab_testing_random_number_FLOAT >= 0.2 AND ab_testing_random_number_FLOAT < 1 THEN 1000
WHEN PRE_CLIP_LINE_LIMIT > 0 AND PRE_CLIP_LINE_LIMIT <= 1000 AND RISKGROUP_DSERIES_Y1 = 2 AND average_utilization_3_months_FLOAT >= 0.1 AND average_utilization_3_months_FLOAT < 0.3 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
WHEN PRE_CLIP_LINE_LIMIT > 0 AND PRE_CLIP_LINE_LIMIT <= 1000 AND RISKGROUP_DSERIES_Y1 = 2 AND average_utilization_3_months_FLOAT >= 0.3 AND average_utilization_3_months_FLOAT < 0.5 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
WHEN PRE_CLIP_LINE_LIMIT > 0 AND PRE_CLIP_LINE_LIMIT <= 1000 AND RISKGROUP_DSERIES_Y1 = 2 AND average_utilization_3_months_FLOAT >= 0.5 AND average_utilization_3_months_FLOAT < 0.8 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
WHEN PRE_CLIP_LINE_LIMIT > 0 AND PRE_CLIP_LINE_LIMIT <= 1000 AND RISKGROUP_DSERIES_Y1 = 2 AND average_utilization_3_months_FLOAT >= 0.8 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
...
WHEN PRE_CLIP_LINE_LIMIT > 0 AND PRE_CLIP_LINE_LIMIT <= 1000 AND RISKGROUP_DSERIES_Y1 = 3 AND average_utilization_3_months_FLOAT >= 0.1 AND average_utilization_3_months_FLOAT < 0.3 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
WHEN PRE_CLIP_LINE_LIMIT > 0 AND PRE_CLIP_LINE_LIMIT <= 1000 AND RISKGROUP_DSERIES_Y1 = 3 AND average_utilization_3_months_FLOAT >= 0.3 AND average_utilization_3_months_FLOAT < 0.5 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
WHEN PRE_CLIP_LINE_LIMIT > 0 AND PRE_CLIP_LINE_LIMIT <= 1000 AND RISKGROUP_DSERIES_Y1 = 3 AND average_utilization_3_months_FLOAT >= 0.5 AND average_utilization_3_months_FLOAT < 0.8 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
WHEN PRE_CLIP_LINE_LIMIT > 0 AND PRE_CLIP_LINE_LIMIT <= 1000 AND RISKGROUP_DSERIES_Y1 = 3 AND average_utilization_3_months_FLOAT >= 0.8 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
...
WHEN PRE_CLIP_LINE_LIMIT > 0 AND PRE_CLIP_LINE_LIMIT <= 1000 AND RISKGROUP_DSERIES_Y1 = 4 AND average_utilization_3_months_FLOAT >= 0.3 AND average_utilization_3_months_FLOAT < 0.5 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
WHEN PRE_CLIP_LINE_LIMIT > 0 AND PRE_CLIP_LINE_LIMIT <= 1000 AND RISKGROUP_DSERIES_Y1 = 4 AND average_utilization_3_months_FLOAT >= 0.5 AND average_utilization_3_months_FLOAT < 0.8 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
WHEN PRE_CLIP_LINE_LIMIT > 0 AND PRE_CLIP_LINE_LIMIT <= 1000 AND RISKGROUP_DSERIES_Y1 = 4 AND average_utilization_3_months_FLOAT >= 0.8 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
...
WHEN PRE_CLIP_LINE_LIMIT > 1000 AND PRE_CLIP_LINE_LIMIT <= 2000 AND RISKGROUP_DSERIES_Y1 = 1 AND average_utilization_3_months_FLOAT > 0 AND average_utilization_3_months_FLOAT < 0.1 AND ab_testing_random_number_FLOAT >= 0.2 AND ab_testing_random_number_FLOAT < 1 THEN 2000
WHEN PRE_CLIP_LINE_LIMIT > 1000 AND PRE_CLIP_LINE_LIMIT <= 2000 AND RISKGROUP_DSERIES_Y1 = 1 AND average_utilization_3_months_FLOAT >= 0.1 AND average_utilization_3_months_FLOAT < 0.3 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
WHEN PRE_CLIP_LINE_LIMIT > 1000 AND PRE_CLIP_LINE_LIMIT <= 2000 AND RISKGROUP_DSERIES_Y1 = 1 AND average_utilization_3_months_FLOAT >= 0.3 AND average_utilization_3_months_FLOAT < 0.5 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
WHEN PRE_CLIP_LINE_LIMIT > 1000 AND PRE_CLIP_LINE_LIMIT <= 2000 AND RISKGROUP_DSERIES_Y1 = 1 AND average_utilization_3_months_FLOAT >= 0.5 AND average_utilization_3_months_FLOAT < 0.8 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
WHEN PRE_CLIP_LINE_LIMIT > 1000 AND PRE_CLIP_LINE_LIMIT <= 2000 AND RISKGROUP_DSERIES_Y1 = 1 AND average_utilization_3_months_FLOAT >= 0.8 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
...
WHEN PRE_CLIP_LINE_LIMIT > 1000 AND PRE_CLIP_LINE_LIMIT <= 2000 AND RISKGROUP_DSERIES_Y1 = 2 AND average_utilization_3_months_FLOAT >= 0.1 AND average_utilization_3_months_FLOAT < 0.3 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
WHEN PRE_CLIP_LINE_LIMIT > 1000 AND PRE_CLIP_LINE_LIMIT <= 2000 AND RISKGROUP_DSERIES_Y1 = 2 AND average_utilization_3_months_FLOAT >= 0.3 AND average_utilization_3_months_FLOAT < 0.5 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
WHEN PRE_CLIP_LINE_LIMIT > 1000 AND PRE_CLIP_LINE_LIMIT <= 2000 AND RISKGROUP_DSERIES_Y1 = 2 AND average_utilization_3_months_FLOAT >= 0.5 AND average_utilization_3_months_FLOAT < 0.8 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
WHEN PRE_CLIP_LINE_LIMIT > 1000 AND PRE_CLIP_LINE_LIMIT <= 2000 AND RISKGROUP_DSERIES_Y1 = 2 AND average_utilization_3_months_FLOAT >= 0.8 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
...
WHEN PRE_CLIP_LINE_LIMIT > 1000 AND PRE_CLIP_LINE_LIMIT <= 2000 AND RISKGROUP_DSERIES_Y1 = 3 AND average_utilization_3_months_FLOAT >= 0.3 AND average_utilization_3_months_FLOAT < 0.5 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
WHEN PRE_CLIP_LINE_LIMIT > 1000 AND PRE_CLIP_LINE_LIMIT <= 2000 AND RISKGROUP_DSERIES_Y1 = 3 AND average_utilization_3_months_FLOAT >= 0.5 AND average_utilization_3_months_FLOAT < 0.8 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
WHEN PRE_CLIP_LINE_LIMIT > 1000 AND PRE_CLIP_LINE_LIMIT <= 2000 AND RISKGROUP_DSERIES_Y1 = 3 AND average_utilization_3_months_FLOAT >= 0.8 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
...
WHEN PRE_CLIP_LINE_LIMIT > 1000 AND PRE_CLIP_LINE_LIMIT <= 2000 AND RISKGROUP_DSERIES_Y1 = 4 AND average_utilization_3_months_FLOAT >= 0.3 AND average_utilization_3_months_FLOAT < 0.5 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
WHEN PRE_CLIP_LINE_LIMIT > 1000 AND PRE_CLIP_LINE_LIMIT <= 2000 AND RISKGROUP_DSERIES_Y1 = 4 AND average_utilization_3_months_FLOAT >= 0.5 AND average_utilization_3_months_FLOAT < 0.8 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
WHEN PRE_CLIP_LINE_LIMIT > 1000 AND PRE_CLIP_LINE_LIMIT <= 2000 AND RISKGROUP_DSERIES_Y1 = 4 AND average_utilization_3_months_FLOAT >= 0.8 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
...
WHEN PRE_CLIP_LINE_LIMIT > 1000 AND PRE_CLIP_LINE_LIMIT <= 2000 AND RISKGROUP_DSERIES_Y1 = 5 AND average_utilization_3_months_FLOAT >= 0.8 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 1000
...
WHEN PRE_CLIP_LINE_LIMIT > 2000 AND PRE_CLIP_LINE_LIMIT <= 3000 AND RISKGROUP_DSERIES_Y1 = 1 AND average_utilization_3_months_FLOAT > 0 AND average_utilization_3_months_FLOAT < 0.1 AND ab_testing_random_number_FLOAT >= 0.2 AND ab_testing_random_number_FLOAT < 1 THEN 2000
WHEN PRE_CLIP_LINE_LIMIT > 2000 AND PRE_CLIP_LINE_LIMIT <= 3000 AND RISKGROUP_DSERIES_Y1 = 1 AND average_utilization_3_months_FLOAT >= 0.1 AND average_utilization_3_months_FLOAT < 0.3 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
WHEN PRE_CLIP_LINE_LIMIT > 2000 AND PRE_CLIP_LINE_LIMIT <= 3000 AND RISKGROUP_DSERIES_Y1 = 1 AND average_utilization_3_months_FLOAT >= 0.3 AND average_utilization_3_months_FLOAT < 0.5 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
WHEN PRE_CLIP_LINE_LIMIT > 2000 AND PRE_CLIP_LINE_LIMIT <= 3000 AND RISKGROUP_DSERIES_Y1 = 1 AND average_utilization_3_months_FLOAT >= 0.5 AND average_utilization_3_months_FLOAT < 0.8 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
WHEN PRE_CLIP_LINE_LIMIT > 2000 AND PRE_CLIP_LINE_LIMIT <= 3000 AND RISKGROUP_DSERIES_Y1 = 1 AND average_utilization_3_months_FLOAT >= 0.8 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
...
WHEN PRE_CLIP_LINE_LIMIT > 2000 AND PRE_CLIP_LINE_LIMIT <= 3000 AND RISKGROUP_DSERIES_Y1 = 2 AND average_utilization_3_months_FLOAT >= 0.1 AND average_utilization_3_months_FLOAT < 0.3 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
WHEN PRE_CLIP_LINE_LIMIT > 2000 AND PRE_CLIP_LINE_LIMIT <= 3000 AND RISKGROUP_DSERIES_Y1 = 2 AND average_utilization_3_months_FLOAT >= 0.3 AND average_utilization_3_months_FLOAT < 0.5 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
WHEN PRE_CLIP_LINE_LIMIT > 2000 AND PRE_CLIP_LINE_LIMIT <= 3000 AND RISKGROUP_DSERIES_Y1 = 2 AND average_utilization_3_months_FLOAT >= 0.5 AND average_utilization_3_months_FLOAT < 0.8 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
WHEN PRE_CLIP_LINE_LIMIT > 2000 AND PRE_CLIP_LINE_LIMIT <= 3000 AND RISKGROUP_DSERIES_Y1 = 2 AND average_utilization_3_months_FLOAT >= 0.8 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
...
WHEN PRE_CLIP_LINE_LIMIT > 2000 AND PRE_CLIP_LINE_LIMIT <= 3000 AND RISKGROUP_DSERIES_Y1 = 3 AND average_utilization_3_months_FLOAT >= 0.3 AND average_utilization_3_months_FLOAT < 0.5 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
WHEN PRE_CLIP_LINE_LIMIT > 2000 AND PRE_CLIP_LINE_LIMIT <= 3000 AND RISKGROUP_DSERIES_Y1 = 3 AND average_utilization_3_months_FLOAT >= 0.5 AND average_utilization_3_months_FLOAT < 0.8 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
WHEN PRE_CLIP_LINE_LIMIT > 2000 AND PRE_CLIP_LINE_LIMIT <= 3000 AND RISKGROUP_DSERIES_Y1 = 3 AND average_utilization_3_months_FLOAT >= 0.8 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
...
WHEN PRE_CLIP_LINE_LIMIT > 2000 AND PRE_CLIP_LINE_LIMIT <= 3000 AND RISKGROUP_DSERIES_Y1 = 4 AND average_utilization_3_months_FLOAT >= 0.5 AND average_utilization_3_months_FLOAT < 0.8 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
WHEN PRE_CLIP_LINE_LIMIT > 2000 AND PRE_CLIP_LINE_LIMIT <= 3000 AND RISKGROUP_DSERIES_Y1 = 4 AND average_utilization_3_months_FLOAT >= 0.8 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 2000
...
WHEN PRE_CLIP_LINE_LIMIT > 3000 AND PRE_CLIP_LINE_LIMIT <= 5000 AND RISKGROUP_DSERIES_Y1 = 1 AND average_utilization_3_months_FLOAT > 0 AND average_utilization_3_months_FLOAT < 0.1 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 0.52 THEN 2000
...
WHEN PRE_CLIP_LINE_LIMIT > 3000 AND PRE_CLIP_LINE_LIMIT <= 5000 AND RISKGROUP_DSERIES_Y1 = 3 AND average_utilization_3_months_FLOAT >= 0.3 AND average_utilization_3_months_FLOAT < 0.5 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 0.52 THEN 2000
...
WHEN PRE_CLIP_LINE_LIMIT > 3000 AND PRE_CLIP_LINE_LIMIT <= 5000 AND RISKGROUP_DSERIES_Y1 = 4 AND average_utilization_3_months_FLOAT >= 0.5 AND average_utilization_3_months_FLOAT < 0.8 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 0.52 THEN 2000
...
WHEN PRE_CLIP_LINE_LIMIT > 3000 AND PRE_CLIP_LINE_LIMIT <= 5000 AND RISKGROUP_DSERIES_Y1 = 5 AND average_utilization_3_months_FLOAT >= 0.5 AND average_utilization_3_months_FLOAT < 0.8 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1 THEN 1000
...
WHEN PRE_CLIP_LINE_LIMIT > 3000 AND PRE_CLIP_LINE_LIMIT <= 5000 AND RISKGROUP_DSERIES_Y1 = 1 AND average_utilization_3_months_FLOAT > 0 AND average_utilization_3_months_FLOAT < 0.1 AND ab_testing_random_number_FLOAT >= 0.52 AND ab_testing_random_number_FLOAT <= 1 THEN 1000
WHEN PRE_CLIP_LINE_LIMIT > 3000 AND PRE_CLIP_LINE_LIMIT <= 5000 AND RISKGROUP_DSERIES_Y1 = 1 AND average_utilization_3_months_FLOAT >= 0.1 AND average_utilization_3_months_FLOAT < 0.3 AND ab_testing_random_number_FLOAT >= 0.52 AND ab_testing_random_number_FLOAT <= 1 THEN 1000
WHEN PRE_CLIP_LINE_LIMIT > 3000 AND PRE_CLIP_LINE_LIMIT <= 5000 AND RISKGROUP_DSERIES_Y1 = 1 AND average_utilization_3_months_FLOAT >= 0.3 AND average_utilization_3_months_FLOAT < 0.5 AND ab_testing_random_number_FLOAT >= 0.52 AND ab_testing_random_number_FLOAT <= 1 THEN 1000
WHEN PRE_CLIP_LINE_LIMIT > 3000 AND PRE_CLIP_LINE_LIMIT <= 5000 AND RISKGROUP_DSERIES_Y1 = 1 AND average_utilization_3_months_FLOAT >= 0.5 AND average_utilization_3_months_FLOAT < 0.8 AND ab_testing_random_number_FLOAT >= 0.52 AND ab_testing_random_number_FLOAT <= 1 THEN 1000
WHEN PRE_CLIP_LINE_LIMIT > 3000 AND PRE_CLIP_LINE_LIMIT <= 5000 AND RISKGROUP_DSERIES_Y1 = 1 AND average_utilization_3_months_FLOAT >= 0.8 AND ab_testing_random_number_FLOAT >= 0.52 AND ab_testing_random_number_FLOAT <= 1 THEN 1000
...
WHEN PRE_CLIP_LINE_LIMIT > 3000 AND PRE_CLIP_LINE_LIMIT <= 5000 AND RISKGROUP_DSERIES_Y1 = 2 AND average_utilization_3_months_FLOAT >= 0.1 AND average_utilization_3_months_FLOAT < 0.3 AND ab_testing_random_number_FLOAT >= 0.52 AND ab_testing_random_number_FLOAT <= 1 THEN 1000
WHEN PRE_CLIP_LINE_LIMIT > 3000 AND PRE_CLIP_LINE_LIMIT <= 5000 AND RISKGROUP_DSERIES_Y1 = 2 AND average_utilization_3_months_FLOAT >= 0.3 AND average_utilization_3_months_FLOAT < 0.5 AND ab_testing_random_number_FLOAT >= 0.52 AND ab_testing_random_number_FLOAT <= 1 THEN 1000
WHEN PRE_CLIP_LINE_LIMIT > 3000 AND PRE_CLIP_LINE_LIMIT <= 5000 AND RISKGROUP_DSERIES_Y1 = 2 AND average_utilization_3_months_FLOAT >= 0.5 AND average_utilization_3_months_FLOAT < 0.8 AND ab_testing_random_number_FLOAT >= 0.52 AND ab_testing_random_number_FLOAT <= 1 THEN 1000
WHEN PRE_CLIP_LINE_LIMIT > 3000 AND PRE_CLIP_LINE_LIMIT <= 5000 AND RISKGROUP_DSERIES_Y1 = 2 AND average_utilization_3_months_FLOAT >= 0.8 AND ab_testing_random_number_FLOAT >= 0.52 AND ab_testing_random_number_FLOAT <= 1 THEN 1000
...
WHEN PRE_CLIP_LINE_LIMIT > 3000 AND PRE_CLIP_LINE_LIMIT <= 5000 AND RISKGROUP_DSERIES_Y1 = 3 AND average_utilization_3_months_FLOAT >= 0.3 AND average_utilization_3_months_FLOAT < 0.5 AND ab_testing_random_number_FLOAT >= 0.52 AND ab_testing_random_number_FLOAT <= 1 THEN 1000
WHEN PRE_CLIP_LINE_LIMIT > 3000 AND PRE_CLIP_LINE_LIMIT <= 5000 AND RISKGROUP_DSERIES_Y1 = 3 AND average_utilization_3_months_FLOAT >= 0.5 AND average_utilization_3_months_FLOAT < 0.8 AND ab_testing_random_number_FLOAT >= 0.52 AND ab_testing_random_number_FLOAT <= 1 THEN 1000
WHEN PRE_CLIP_LINE_LIMIT > 3000 AND PRE_CLIP_LINE_LIMIT <= 5000 AND RISKGROUP_DSERIES_Y1 = 3 AND average_utilization_3_months_FLOAT >= 0.8 AND ab_testing_random_number_FLOAT >= 0.52 AND ab_testing_random_number_FLOAT <= 1 THEN 1000
...
WHEN PRE_CLIP_LINE_LIMIT > 3000 AND PRE_CLIP_LINE_LIMIT <= 5000 AND RISKGROUP_DSERIES_Y1 = 4 AND average_utilization_3_months_FLOAT >= 0.5 AND average_utilization_3_months_FLOAT < 0.8 AND ab_testing_random_number_FLOAT >= 0.52 AND ab_testing_random_number_FLOAT <= 1 THEN 1000
WHEN PRE_CLIP_LINE_LIMIT > 3000 AND PRE_CLIP_LINE_LIMIT <= 5000 AND RISKGROUP_DSERIES_Y1 = 4 AND average_utilization_3_months_FLOAT >= 0.8 AND ab_testing_random_number_FLOAT >= 0.52 AND ab_testing_random_number_FLOAT <= 1 THEN 1000
...
WHEN PRE_CLIP_LINE_LIMIT > 3000 AND PRE_CLIP_LINE_LIMIT <= 5000 AND RISKGROUP_DSERIES_Y1 = 1 AND average_utilization_3_months_FLOAT > 0 AND average_utilization_3_months_FLOAT < 0.1 AND ab_testing_random_number_FLOAT >= 0 AND ab_testing_random_number_FLOAT <= 0.02 THEN 0
...
WHEN PRE_CLIP_LINE_LIMIT > 3000 AND PRE_CLIP_LINE_LIMIT <= 5000 AND RISKGROUP_DSERIES_Y1 = 5 AND average_utilization_3_months_FLOAT >= 0.5 AND average_utilization_3_months_FLOAT < 0.8 AND ab_testing_random_number_FLOAT >= 0 AND ab_testing_random_number_FLOAT <= 0.02 THEN 0
